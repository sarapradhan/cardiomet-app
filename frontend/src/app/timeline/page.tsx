...
export default function TimelinePage() {
  ...
  return (
    <div style={{ maxWidth: 1120, margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div>
      ...
      {/* Landscape two-column: draw-entry form left, draws list + actions right */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
        {/* Draw meta */}
        <div className="lg:col-span-2 card" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="panel-sunken">
            <span className="caption"><strong>Your data, your file.</strong> Nothing is stored on our
            servers — export to keep your history, import to continue tracking.</span>
          </div>
        </div>
      </div>
